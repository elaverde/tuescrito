                                    ...
                                    <form class="row g-3 needs-validation" @submit.prevent="login" novalidate>
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input require v-model="email" type="text" name="username" class="form-control" id="yourUsername" required>
                                                <div class="invalid-feedback">Por favor ingrese su usuario</div>
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <label for="yourPassword" class="form-label">Contraseña</label>
                                            <input require v-model="password" type="password" name="password" class="form-control" id="yourPassword" required>
