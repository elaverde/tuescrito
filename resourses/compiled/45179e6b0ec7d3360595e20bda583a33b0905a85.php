  ...
  <nav>
    <ul class="pagination">
      <li class="page-item" v-if="pagination.prev_page_url">
        <a class="page-link" href="#" @click.prevent="goToPage(pagination.current_page - 1,pagechange)">Previous</a>
      </li>
      ...
      <li class="page-item" v-if="pagination.next_page_url">
        <a class="page-link" href="#" @click.prevent="goToPage(pagination.current_page + 1,pagechange)">Next</a>
      </li>
    </ul>
  </nav>
</template>
