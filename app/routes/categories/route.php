...
return function (App $app) {
     ...
     */
    $app->post('/category', 'App\Controllers\CategoriesController:store');
    /**
     ...
     * - description: string descripcion de la categoria (requerido)
     */
    $app->put('/category/{id}', 'App\Controllers\CategoriesController:update');
    /**
     * Endpoint para eliminar una categoria
     */
    $app->delete('/category/{id}', 'App\Controllers\CategoriesController:delete');
    /**
